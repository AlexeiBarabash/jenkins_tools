...
def call() {
    ...
    this.env.SERVERS = SERVERS
    this.env.GIT_REPO = GIT_REPO
    this.env.CONTAINER_NAME_REPO = CONTAINER_NAME_REPO
    this.env.CONTAINER_NAME = CONTAINER_NAME
    this.env.CONTAINER_VERSION = CONTAINER_VERSION
    this.env.ENV = ENV
    this.env.BUILDER_NAME = BUILDER_NAME
    this.env.BRANCH_TO_CLONE = BRANCH_TO_CLONE
}